...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::plan_question::QuestionCategory::decl(),
        services::services::task_clarification::ClarificationQuestion::decl(),
        services::services::task_clarification::ClarificationAnswer::decl(),
        ...
        server::routes::tasks::StartPlanningResponse::decl(),
        server::routes::tasks::PlanAnswerInput::decl(),
        server::routes::tasks::SavePlanAnswersRequest::decl(),
        server::routes::tasks::SavePlanAnswersResponse::decl(),
        server::routes::tasks::PlanningSyncInfo::decl(),
        server::routes::tasks::CompletePlanningResponse::decl(),
